...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Идентификатор пользователя : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         <p> Размещено : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <input type="submit" name="update_order" value="Обнавить" class="option-btn">
